...
export function sendReferralJoinedNotification(
  ...
  sendNotificationAsync({
    ...
    title: `Your referral @${referredLogin} just joined Github World!`,
    body: `@${referredLogin} joined Github World through your referral link.`,
    html: `
      ...
      <h1 style="margin:0 0 8px; font-size:24px; font-weight:bold; color:#111111; font-family:Helvetica,Arial,sans-serif;">@${referredLogin} is in Github World!</h1>
