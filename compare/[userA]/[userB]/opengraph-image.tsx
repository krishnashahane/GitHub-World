...
export const alt = "Developer Comparison - Github World";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span style={{ fontSize: 34, color: cream }}>GITHUB</span>
          <span style={{ fontSize: 34, color: accent }}>WORLD</span>
          <span style={{ fontSize: 16, color: muted, marginLeft: 8 }}>by @krishnashahane</span>
        </div>
      </div>
    ),
    {
