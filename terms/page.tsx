...
export const metadata: Metadata = {
  title: "Terms of Service - Github World",
  description: "Terms of Service for Github World.",
};
      ...
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="mt-8 flex flex-col gap-5">
          <Section n={1} title="The Service">
            <p>
              Github World is a web application that visualizes GitHub profiles as 3D
              buildings in a virtual city. By using Github World, you agree to these
              terms.
            </p>
          </Section>
          ...
          <Section n={3} title="User Conduct">
            ...
            <ul className="mt-1 flex flex-col gap-1">
              ...
              <Li>Scrape or collect data from Github World without permission</Li>
          ...
          <Section n={4} title="Intellectual Property">
            <p>
              Github World, its code, design, and branding are owned by Krishna
              Shahane. Your GitHub data remains yours. By using the service, you
          ...
          <Section n={5} title="Purchases & Shop">
            <p>
              Github World offers optional cosmetic items for purchase. All purchases
              are final and non-refundable unless required by applicable law.
              Cosmetic items have no real-world value and exist only within Github
              World.
            </p>
          </Section>
          ...
          <Section n={6} title="Disclaimer of Warranties">
            <p>
              Github World is provided &quot;as is&quot; and &quot;as
          ...
          <Section n={7} title="Limitation of Liability">
            <p>
              To the maximum extent permitted by law, Krishna Shahane and Github World
          ...
          <Section n={8} title="Third-Party Token">
            <p>
              ...
              created by the community, not by Github World or Krishna Shahane. We do
          ...
          <Section n={9} title="Changes to Terms">
            <p>
              We may update these terms at any time. Continued use of Github World
