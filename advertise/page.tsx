...
export const metadata: Metadata = {
  title: "Advertise on Github World",
  description:
        ...
        {ctr > 0.5 && (
          <div className="mt-8 border-[3px] border-border p-5 sm:p-6">
            <p className="text-base text-cream">
              Github World vs traditional ads
            </p>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  a: "You can cancel your subscription anytime. Your ad stays active until the end of the current billing period. Contact krishnashahane@gmail.com if you need help.",
                },
              ].map((item) => (
