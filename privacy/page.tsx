...
export const metadata: Metadata = {
  title: "Privacy Policy - Github World",
  description: "Privacy Policy for Github World.",
};
      ...
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="mt-8 flex flex-col gap-5">
          ...
          <Section n={8} title="Children">
            <p>
              Github World is not intended for children under 13. We do not knowingly
          ...
          <Section n={9} title="Changes">
            <p>
              We may update this policy at any time. Continued use of Github World
