        ...
        <table role="presentation" class="wrapper" width="560" cellpadding="0" cellspacing="0" border="0" style="max-width: 560px; width: 100%;">
          ...
          <tr>
            <td align="center" style="padding-bottom: 24px;">
              <img src="${BASE_URL}/icon-512.png" width="64" height="64" alt="Github World" style="display:block; border-radius:16px; border:0;" />
            </td>
          </tr>
          ...
          <tr>
            <td align="center" style="padding-top: 24px;">
              <p style="margin: 0; font-size: 12px; color: #999999; font-family: Helvetica, Arial, sans-serif;">
                ${footer}<a href="${BASE_URL}" style="color: #999999; text-decoration: none; font-size: 12px;">Github World</a>
              </p>
            </td>
          </tr>
