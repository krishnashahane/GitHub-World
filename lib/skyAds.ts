...
export function buildAdLink(ad: SkyAd): string | undefined {
  ...
  try {
    ...
    url.searchParams.set("utm_source", "ghworld");
...
export const DEFAULT_SKY_ADS: SkyAd[] = [
  ...
  },
  {
    ...
    brand: "Sky Ads",
    description: "Want your brand flying over Github World? Planes, blimps, your colors. Get in touch!",
    color: "#f8d880",
    bgColor: "#1a1018",
    link: "https://localhost:3001/advertise",
    vehicle: "plane",
    priority: 10,
  },
];
