...
const BASE_URL = process.env.NEXT_PUBLIC_APP_URL || "https://localhost:3001";
...
export function sendWelcomeNotification(devId: number, login: string, rank?: number) {
  ...
  sendNotificationAsync({
    ...
    title: `Welcome to Github World, @${login}!`,
    body: `Your building is live in Github World. ${rankText} Check in daily to grow your streak and unlock items.`,
    html: `
      ...
      <p style="margin:0 0 20px; font-size:15px; color:#555555; line-height:1.6;">Github World is a living city built from GitHub contributions. Here's how to get started:</p>
