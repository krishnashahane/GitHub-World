        ...
        {error ? (
          <>
            ...
            <p style={{ color: "#666", fontSize: 14 }}>
              ...
              You can manage your notifications from your Github World settings.
            </p>
          </>
        ) : success ? (
          <>
            ...
            <p style={{ color: "#666", fontSize: 14 }}>
              You can re-enable notifications anytime from your Github World settings.
            </p>
          </>
        ) : (
          <p style={{ color: "#666", fontSize: 14 }}>
