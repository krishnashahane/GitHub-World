...
const TIERS: ReEngagementTier[] = [
  {
    ...
    body: (login) => `Hey @${login}, your building in Github World is waiting. Come check in!`,
  ...
  },
  {
    ...
    html: (login, extraInfo) => `
      ...
      <p style="color: #f0f0f0;">New developers have joined Github World since your last visit, @${login}.</p>
      ${extraInfo}
  ...
  },
  {
    ...
    html: (login, extraInfo) => `
      ...
      ${extraInfo}
      ${buildButton("Visit Github World", `${BASE_URL}/?user=${login}`)}
    `,
  },
];
